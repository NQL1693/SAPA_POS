...
export function PaymentDialog({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center overflow-y-auto bg-[#4b2734]/40 p-2 backdrop-blur-sm sm:items-center sm:p-4">
      <div className="pos-modal max-h-[calc(100dvh-16px)] w-full max-w-md overflow-y-auto rounded-[26px] bg-white shadow-2xl sm:max-h-[90vh] sm:rounded-[30px]">

        {/* HEADER */}
        <div className="border-b border-[#f5dfe6] bg-[#fff6f9] px-4 py-4 sm:px-6 sm:py-5">
